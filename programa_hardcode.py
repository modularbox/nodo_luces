    ...
    def get_luces_lugar(self):
        if(self.lugar == 'saucedilla'):
            return {
                ...
                "encender": [1, [2, 170], 4, 11, [12, 170], 14, 21, [22, 170], 24, 31, [32, 170], 34, 41, [42, 170], 44, 51, [52, 170], 54, 61, [62, 170], 64, 71, [72, 170], 74, 81, [82, 170], 84, 91, [92, 170], 94, 101, [102, 170], 104, 111, [112, 170], 114, 121, [122, 170], 124, 131, [132, 170], 134, 141, [142, 170], 144, 151, [152, 170], 154, 161, [162, 170], 164, 171, [172, 170], 174, 181, [182, 170], 184,
        ...
        if(self.lugar == 'campanario'):
            ...
            return {
                ...
                "encender": 
                [2, 10, 17, 18, 19, 20, 26, 31, 36, 41, 46, 50,
                 51, 52, 53,  59, 67, 75, 83, 91, 99]
                }
